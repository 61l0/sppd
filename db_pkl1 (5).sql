...
--
-- Host: localhost
-- Generation Time: Feb 20, 2015 at 03:17 
...
('0052', '19590814 198112 1 056', 'Ahmad Riyanto S.pd', 111, 11, '421.024'),
...
('PNS0012', '19590814 198112 1 045', 'Ir. DWI SISWAHYUDI, MT', 111, 10, '421.024'),
...
('PNS0047', '19590814 198112 1 076', 'Paejan S.kom', 111, 9, '421.034'),
...
INSERT INTO `tbl_skpd` (`id_skpd`, `kode_skpd`, `nama_skpd`, `alamat_skpd`, `telepon_skpd`, `email_skpd`, `website_skpd`) VALUES
(1, '-', '-', '-', '-', '-', '-'),
(2, '421.011', 'Bagian Tata Pemerintahan Umum', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '', 'bag-tapum@malangkab.go.id', 'http://bag-pde.malangkab.go.id'),
(3, '421.012', 'Bagian Tata Pemerintahan Desa', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '', 'bag-tapemdes@malangkab.go.id', 'http://bag-tapum.malangkab.go.id'),
(4, '421.013', 'Bagian Hukum', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '', 'bag-hukum@malangkab.go.id', 'http://bag-tapemdes.malangkab.go.id'),
(5, '421.014', 'Bagian Pertanahan', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '', 'bag-pertanahan@malangkab.go.id', 'http://bag-pertanahan.malangkab.go.id'),
(6, '421.021', 'Bagian Perekonomian', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '', 'bag-ekonomi@malangkab.go.id', 'http://bag-hukum.malangkab.go.id'),
(7, '421.022', 'Bagian Kerjasama', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '', 'bag-kerjasama@malangkab.go.id', 'http://bag-ekonomi.malangkab.go.id'),
(8, '421.023', 'Bagian Administrasi Pembangunan', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '', 'bag-pembangunan@malangkab.go.id', 'http://bag-kerjasama.malangkab.go.id'),
(9, '421.024', 'Bagian Pengelola Data Elektronik', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '(0341) 392029', 'bag-pde@malangkab.go.id', 'http://bag-pembangunan.malangkab.go.id'),
(10, '421.031', 'Bagian Umum dan Protokol', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '', 'bag-umum@malangkab.go.id', 'http://bag-umum.malangkab.go.id'),
(11, '421.032', 'Bagian Tata Usaha', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '', 'bag-tu@malangkab.go.id', 'http://bag-tu.malangkab.go.id'),
(12, '421.033', 'Bagian Hubungan Masyarakat', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '', 'bag-humas@malangkab.go.id', 'http://bag-humas.malangkab.go.id'),
(13, '421.034', 'Bagian Organisasi', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '', 'bag-organisasi@malangkab.go.id', 'http://bag-organisasi.malangkab.go.id'),
(14, '421.041', 'Bagian Kesejahteraan Rakyat', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '', 'bag-kesra@malangkab.go.id', 'http://bag-organisasi.malangkab.go.id'),
(15, '421.042', 'Bagian Bina Mental', 'Jl. Panji No. 158 Kepanjen Kabupaten Malang', '', 'bag-bintal@malangkab.go.id', 'http://bag-bintal.malangkab.go.id'),
(16, '421.050', 'Sekretariat Dewan', '-', '-', '-', '-'),
(17, '421.051', 'Staf Ahli', '-', '-', '-', '-'),
(18, '421.060', 'Sekretariat Daerah', 'Jalan Merdeka Timur No. 3 Malang', '( 0341 ) 326791 - 326793 ', ' sekda@malangkab.go.id', 'http:// www.malangkab.go.id '),
(19, '421.101', 'Dinas Pendidikan', 'Jl.Panarukan No. 1 Kepanjen', '(0341) 393935', 'dispendik@malangkab.go. id', 'http://dispendik.malangkab.go.id'),
(20, '421.102', 'Dinas Pemuda dan olahraga', 'Jl.Trunojoyo Kompleks Stadion Kanjuruhan Kepanjen', '(0341) 399909', 'dispora@malangkab.go.id', 'http://dispora.malangkab.go.id'),
(21, '421.103', 'Dinas Kesehatan', 'Jl. Panji No. 120, Kepanjen', '(0341) 393730', 'dinkes@malangkab.go.id', 'http://dinkes.malangkab.go.id'),
(22, '421.104', 'Dinas Sosial', 'Jl. Majapahit No.5 Malang', '(0341) 362601', 'dinsos@malangkab.go.id', 'http://dinsos.malangkab.go.id'),
(23, '421.105', 'Dinas Tenaga Kerja dan Transmigrasi', 'Jl.Trunojoyo Kav. 3 Kepanjen', '(0341) 393933', 'disnaker@malangkab.go.id', 'http://disnaker.malangkab.go.id'),
(24, '421.106', 'Dinas Perhubungan, Komunikasi dan Informatika', 'Jl.Merdeka Timur No.3 Malang', '(0341) 350888', 'dishub@malangkab.go. Id', 'http://dishub.malangkab.go.id'),
(25, '421.107', 'Dinas Kependudukan dan Catatan Sipil', 'Jl. Panji No119, Kepanjen', '(0341) 394100', 'dispenduk@malangkab.go.id', 'http://dispenduk.malangkab.go.id'),
(26, '421.108', 'Dinas Kebudayaan dan Pariwisata', 'Jl. Raya Singosari, Malang', '(0341) 456644', 'disbudpar@malangkab.go.id', 'http://disbudpar.malangkab.go.id'),
(27, '421.109', 'Dinas Bina Marga', 'Jl. KH.Agus Salim No.7 Malang', '(0341) 361160', 'binamarga@malangkab.go.Id', 'http://binamarga.malangkab.go.id'),
(28, '421.110', 'Dinas Pengairan', 'Jl. Kawi No. 1, Kepanjen', '(0341) 395025', 'pengairan@malangkab.go.id', 'http://pengairan.malangkab.go.id'),
(29, '421.111', 'Dinas Cipta Karya dan Tata Ruang', 'Jl. Trunojoyo kapling 6 Kepanjen Kabupaten Malang', '(0341) 391679 ', 'ciptakarya@malangkab.go.id', 'http://ciptakarya.malangkab.go.id'),
(30, '421.112', 'Dinas Koperasi, Usaha Mikro, Kecil dan Menengah', 'Jl. Trunojoyo Kav. 1, Kepanjen?', '(0341) 393921', 'dinkop@malangkab.go.id', 'http://dinkop.malangkab.go.id'),
(31, '421.113', 'Dinas Perindustrian, Perdagangan dan Pasar', 'Jl. Trunojoyo Kav. 6, Kepanjen', '(0341) 391673', 'disperindag@malangkab.go.id', 'http://disperindag.malangkab.go.id'),
(32, '421.114', 'Dinas Pertanian dan Perkebunan', 'Jl.Sumedang No. 28 Kepanjen', '(0341) 396893', 'distanbun@malangkab.go.id', 'http://distanbun.malangkab.go.id'),
(33, '421.115', 'Dinas Kelautan dan Perikanan', 'Jl. Panji No.119 Kepanjen Malang. Belakang kantor DPRD', '(0341) 399755', 'kelautan@malangkab.go.id', 'http://kelautan.malangkab.go.id'),
(34, '421.116', 'Dinas Kehutanan', 'Jl. Raya Genengan KM. 9,3, Pakisaji Malang', '(0341) 806454', 'kehutanan@malangkab.go.id', 'http://kehutanan.malangkab.go.id'),
(35, '421.117', 'Dinas Energi dan Sumberdaya Mineral', 'Jl. A. Yani Utara No. 384B Malang', '(0341) 408788', 'esdm@malangkab.go.id', 'http://esdm.malangkab.go.id'),
(36, '421.118', 'Dinas Peternakan dan Kesehatan Hewan', 'Jl. Trunojoyo Kav. 4 Kepanjen', '(0341) 393926', 'peternakan@malangkab.go.id', 'http://peternakan.malangkab.go.id'),
(37, '421.119', 'Dinas Pendapatan, Pengelolaan Keuangan dan Aset', 'Jl. KH.Agus Salim No.7 Malang', '(0341) 362372', 'dppka@malangkab.go.id', 'http://dppka.malangkab.go.id'),
(38, '421.201', 'Dinas Inspektorat Kabupaten', '', '', '', ''),
(39, '421.202', 'Badan Kepegawaian Daerah', 'Jl. KH.Agus Salim No.7 Malang', '(0341) 364776', 'bkd@malangkab.go.id', 'http://bkd.malangkab.go.id'),
(40, '421.203', 'Badan Perencanaan Pembangunan', 'Jl. Panji No. 158 Kepanjen', '(0314) 392322', 'bappekab@malangkab.go.id', 'http://bappekab.malangkab.go.id'),
(41, '421.204', 'Badan Penelitian dan Pengembangan', 'Jl.KH Agus Salim No 7 Malang', '(0341) 369390', 'balitbang@malangkab.go.id', 'http://balitbang.malangkab.go.id'),
(42, '421.205', 'Badan Kesatuan Bangsa dan Politik', 'Jl.KH. Agus Salim No.7 Malang', '(0341) 366260', 'bakesbangpol@malangkab.go.id', 'http://bakesbangpol.malangkab.go.id'),
(43, '421.206', 'Badan Lingkungan Hidup', 'Jl. KH Agus Salim No. 7 Malang', '(0341) 393924', 'lh@malangkab.go.id', 'http://lh.malangkab.go.id'),
(44, '421.207', 'Badan Ketahanan Pangan dan Pelaksana Penyuluhan', 'Jl. Raya Karangduren No. 1 Pakisaji - Malang', '(0341) 804423', 'bkp3@malangkab.go.id', 'http://bkp3.malangkab.go.id'),
(45, '421.208', 'Badan Pemberdayaan Masyarakat', 'Jl Merdeka Timur No. 3 Malang', '(0341) 399755', 'bpm@malangkab.go.id', 'http://bpm.malangkab.go.id'),
(46, '421.209', 'Badan Pendidikan dan Pelatihan', 'Jl. Merdeka Timur No. 3 Malang', ' (0341) 393931', 'diklat@malangkab.go.id', 'http://diklat.malangkab.go.id'),
(47, '421.210', 'Badan Keluarga Berencana', 'Jl. Trunojoyo 10 Kepanjen', '(0341) 395294', 'kb@malangkab.go.id', 'http://kb.malangkab.go.id'),
(48, '421.211', 'Badan Perpustakaan dan Arsip Daerah', 'Jl. Panglima Sudirman No. 19 Kepanjen', '(0341) 397789', 'perpustakaan@malangkab.go.id', 'http://perpustakaan.malangkab.go.id'),
(49, '421.214', 'Badan Perumahan', 'Jl. Nusa Barong No. 13 Malang', '(0341) 341894', 'perumahan@malangkab.go.id', 'http://perumahan.malangkab.go.id'),
(50, '421.216', 'Badan Penanggulangan Bencana Daerah', 'Jl. Trunojoyo Kepanjen', '(0341) 392220', 'bpbd@malangkab.go.id', 'http://bpbd.malangkab.go.id'),
(51, '421.302', 'Badan Pelayanan Perizinan Terpadu', 'Jl. Trunojoyo Kav. 6 Kepanjen', '(0341) 396633', 'perizinan@malangkab.go.id', 'http://perizinan.malangkab.go.id'),
(52, '421.999', 'skpd', 'skpd', 'asd', 'as', '421.999');
...
--
ALTER TABLE `tbl_sdm`
 ADD PRIMARY KEY (`kd_sdm`), ADD KEY `kd_jabatan` (`kd_jabatan`), ADD KEY `kd_pg` (`kd_pg`), ADD KEY `kode_skpd` (`kode_skpd`);

--
-- Indexes for table `tbl_skpd`
--
ALTER TABLE `tbl_skpd`
 ADD PRIMARY KEY (`id_skpd`), ADD UNIQUE KEY `kode_skpd` (`kode_skpd`);
...
--
ALTER TABLE `tbl_skpd`
MODIFY `id_skpd` int(7) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=53;
--
...
ADD CONSTRAINT `tbl_sdm_ibfk_3` FOREIGN KEY (`kode_skpd`) REFERENCES `tbl_skpd` (`kode_skpd`) ON DELETE CASCADE ON UPDATE CASCADE;
